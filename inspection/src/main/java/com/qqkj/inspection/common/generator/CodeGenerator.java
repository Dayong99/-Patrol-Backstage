package com.qqkj.inspection.common.generator;
...
{
    // 数据库 URL
    private static final String URL = "jdbc:mysql://192.168.1.2:3306/inspection?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    ...
    // @author 值
    private static final String AUTHOR = "qqkj";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.qqkj.inspection";
    // xml文件路径
    ...
    public static void main(String[] args)
    {
        ...
        packageConfig.setModuleName("inspection");
