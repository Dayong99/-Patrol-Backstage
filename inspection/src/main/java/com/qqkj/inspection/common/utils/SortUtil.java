...
import com.qqkj.inspection.common.domain.QueryRequest;
...
public class SortUtil
{
    ...
    public static void handlePageSort(QueryRequest request, Page page, String defaultSort, String defaultOrder, boolean camelToUnderscore)
    {
        ...
        {
            sortField = OilUtil.camelToUnderscore(sortField);
            defaultSort = OilUtil.camelToUnderscore(defaultSort);
        }
        if (StringUtils.isNotBlank(request.getSortField()) && StringUtils.isNotBlank(request.getSortOrder()) && !StringUtils.equalsIgnoreCase(request.getSortField(), "undefined") && !StringUtils.equalsIgnoreCase(request.getSortOrder(), "undefined"))
        {
            if (StringUtils.equals(request.getSortOrder(), OilConstant.ORDER_DESC))
            {
        ...
        else
        {
            ...
            {
                if (StringUtils.equals(defaultOrder, OilConstant.ORDER_DESC))
                {
